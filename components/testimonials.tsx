        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-800" data-aos="fade-up">
              ...
              <blockquote className="text-lg text-gray-400 grow">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Facilis similique exercitationem culpa, quos quidem, quam deserunt quasi vitae, id sed est? Ad quam fugiat culpa hic animi deleniti perferendis exercitationem.</blockquote>
